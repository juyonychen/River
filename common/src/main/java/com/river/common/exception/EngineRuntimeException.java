...
public class EngineRuntimeException extends RuntimeException {
    ...
    protected EngineRuntimeException(String message, ErrorCode errorCode, Object... messageParams) {
        this(message, null, errorCode, messageParams);
    }

    protected EngineRuntimeException(Throwable cause, ErrorCode errorCode) {
     ...
     */
    protected EngineRuntimeException(String message, Throwable cause, ErrorCode errorCode, Object... messageParams) {
        super(cause);
        if (errorCode == null) {
